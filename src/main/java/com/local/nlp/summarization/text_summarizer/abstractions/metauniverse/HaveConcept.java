 ...
 *
 */
public class HaveConcept extends ActionConcept{
	
	protected ActionConcept SupportedAction;
	
	protected ActionConcept ImpliedAction;
	
	public HaveConcept(String name) {
		super(name);
	}
	...
	public ActionConcept getImpliedAction() {
		return ImpliedAction;
	}

	public void setImpliedAction(ActionConcept impliedAction) {
